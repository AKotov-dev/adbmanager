...
function TReadAppsTRD.RunCmd(const ACommand: string; AOutput: TStringList): boolean;
var
  ExProcess: TProcess;
begin
  Result := False;
...
procedure TReadAppsTRD.Execute;
var
...
procedure TReadAppsTRD.ShowAppList;
var
  hText, hIcon: integer;
begin
...
//Останов потока
procedure TReadAppsTRD.StopRead;
var
  i, j: integer;
begin
